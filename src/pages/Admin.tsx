      ...
      <div className="pt-24 pb-10 px-4">
        <div className="container mx-auto">
          <div className="flex gap-6">
            ...
            <aside
              className={cn(
                "hidden lg:flex flex-col bg-card rounded-2xl shadow-lg p-4 transition-all duration-300 border border-border/50",
            ...
            >
              <div className="flex items-center gap-3 px-4 py-3 mb-6">
                ...
                {sidebarOpen && (
                  <span className="font-serif font-bold text-foreground text-lg">Admin Panel</span>
                )}
              </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      activeTab === item.id
                        ...
                        : "text-muted-foreground hover:bg-secondary/80 hover:text-foreground hover:shadow-md"
                    )}
                  >
                    ...
                    {item.badge && item.badge > 0 && (
                      <span className={cn(
                        "absolute right-3 top-1/2 -translate-y-1/2 min-w-[20px] h-5 px-1.5 text-xs font-bold rounded-full flex items-center justify-center",
                        activeTab === item.id
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {statsCards.map((stat, index) => {
                      const gradients = {
                        primary: "from-purple-500/20 via-pink-500/20 to-purple-500/20",
                        accent: "from-blue-500/20 via-cyan-500/20 to-blue-500/20",
                        success: "from-green-500/20 via-emerald-500/20 to-green-500/20",
                        warm: "from-orange-500/20 via-red-500/20 to-orange-500/20",
                      };
                      ...
                      return (
                        <div
                          key={stat.title}
                          className="relative overflow-hidden bg-card rounded-2xl p-6 shadow-card group hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
                        ...
                        >
                          ...
                          <div className="relative z-10">
                            <div className="flex items-center justify-between mb-4">
                              <div
                                className={cn(
                                  "w-14 h-14 rounded-xl flex items-center justify-center bg-gradient-to-br shadow-lg transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3",
                                  iconGradients[stat.color as keyof typeof iconGradients]
                                )}
                              >
