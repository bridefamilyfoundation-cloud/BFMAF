...
import { Users, MessageSquare, Award, FileText, ListOrdered, HelpCircle, Camera, Star } from "lucide-react";
    ...
    return (
        ...
        <div className="space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsList className="grid grid-cols-4 lg:grid-cols-8 gap-2 h-auto p-2 bg-secondary/30">
